  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: '合同会社Steg公式ホームページ。Web制作案件の受託や、iOSアプリ開発の受託などを行なっています。' },
      { hid: 'og:site_name', property: 'og:site_name', content: '合同会社Steg公式ホームページ' },
      { hid: 'og:type', property: 'og:type', content: 'website' },
      { hid: 'og:url', property: 'og:url', content: 'https://team-steg.com' },
      { hid: 'og:title', property: 'og:title', content: '合同会社Steg公式ホームページ' },
      { hid: 'og:description', property: 'og:description', content: '合同会社Steg公式ホームページ。Web制作案件の受託や、iOSアプリ開発の受託などを行なっています。' },
